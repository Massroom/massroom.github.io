  ...
  setTimeout(async function() {
    ...
    if (role === null) {
      ...
      <div style="display: flex; align-items: center; gap: 3px;">
        <svg width="16" height="16" style="fill: #00f52d;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-label="Massroom Dev" data-balloon-pos="up">
      ...
      html = `
      <div style="display: flex; align-items: center; gap: 3px;">
        <svg width="16" height="16" style="fill: #00f52d;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-label="Moderator" data-balloon-pos="up">
